...
class CreateBookingsTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('booking_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'booking');
        ...
        Schema::create('booking_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'booking');
        });
        ...
        Schema::create('booking_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'booking');
        });
    }
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('booking_slugs');

...
class CreateCarsTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('car_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'car');
        ...
        Schema::create('car_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'car');
        });
        ...
        Schema::create('car_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'car');
        });
    }
